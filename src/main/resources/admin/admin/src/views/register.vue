<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于Spring Boot的在线考试系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.xueshengzhanghao" class="input" type="text" placeholder="学生账号">
			   </div>
			 </div> -->
			<el-form-item label="学生账号" class="input" v-if="tableName=='xuesheng'">
			  <el-input v-model="ruleForm.xueshengzhanghao" autocomplete="off" placeholder="学生账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xuesheng'" class="input-group">
			...
			<el-form-item label="电话号码" class="input" v-if="tableName=='xuesheng'">
			...
			<el-form-item label="电话号码" class="input" v-if="tableName=='jiaoshi'">
			  <el-input v-model="ruleForm.dianhuahaoma" autocomplete="off" placeholder="电话号码"  />
			</el-form-item>
 ...
 //  }
	...
	.container {
		...
		background-repeat: no-repeat;
    				background-image: url(http://codegen.caihongy.cn/20220103/939a85c3d0af452bb710183b452474cc.png);
      ...
      box-sizing: border-box;
        ...
        .send-code {
          ...
          line-height:44px;
					...
					border-width: 1px;
					border-style: solid;
					border-color: rgba(185, 231, 254, 1);
					border-radius: 4px;
					background-color: rgba(185, 231, 254, 1);
          box-shadow: 0 0 6px rgba(255,0,0,0);
				}
